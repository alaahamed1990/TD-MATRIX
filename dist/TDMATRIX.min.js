...
class Document
{constructor()
{this.value="";this.terms={};this.length=0;this.isEndedProperly=null;}
...
{return null;}
var resultSentences=[];var sentences=quote.match(statmentDelimeters);var tmpSentence=null;var processedTokens=null;var isEndOfSentence=false;var isLastTokenNumber=false;var docFrequencies={};var tmpDocument=new Document();var lastToken=null;for(var sentenceIndex in sentences)
...
{return null;}
var documentSet=new DisJointSet();var calculatedDistances={};if(documents.length==1)
{documentSet.createset(0);return documentSet;}
for(var i=0;i<documents.length-1;++i)
{var totaldistance=0;var mainNodeParent;for(var s=i+1;s<documents.length;++s)
{var curretNodeParent=-1;var distance=-1;if(!IsDefined(calculatedDistances[i]))
{calculatedDistances[i]=0;}
if(!IsDefined(calculatedDistances[s]))
{calculatedDistances[s]=0;}
distance=this.GetDistance(documents[i],documents[s]);var mainNodeParent=documentSet.find(i);var currentNodeParent=documentSet.find(s);var inSameSet=false;if(mainNodeParent!=currentNodeParent)
{if(distance<=simThrShold)
{mainNodeParent=curretNodeParent=documentSet.join(i,s);calculatedDistances[i]+=distance;calculatedDistances[s]+=distance;inSameSet=true;}}
